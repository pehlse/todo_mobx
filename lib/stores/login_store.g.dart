...
mixin _$LoginStore on _LoginStore, Store {
  ...
  String toString() {
    final string =
        'isloading: ${isloading.toString()},isObscure: ${isObscure.toString()},email: ${email.toString()},loggedIn: ${loggedIn.toString()},password: ${password.toString()},isFormValid: ${isFormValid.toString()},loginPressed: ${loginPressed.toString()}';
    return '{$string}';
  }
}
